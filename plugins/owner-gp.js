...
const handler = async (m, { conn, text, usedPrefix, command }) => {
	...
	const _sizeText = fileSize < 1024 ? `${fileSize} B` : fileSize < 1024 * 1024 ? `${(fileSize / 1024).toFixed(1)} KB` : `${(fileSize / (1024 * 1024)).toFixed(1)} MB`;

	const _icon = getFileIcon(pluginName);
